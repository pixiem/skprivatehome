                  ...
                  <li key={index}>
                    <div className="bd-header-cart-content">
                      ...
                      <div className="bd-header-cart-title-wrapper">
                        <h4 className="bd-header-cart-title"><Link href={`/shop-details/${item.id}`}>{item.title}</Link></h4>
                    ...
                    <div className="bd-header-cart-remove text-end">
                      <button className="remove-item" onClick={() => dispatch(remove_cart_product(item))}><i className="fa-solid fa-xmark"></i></button>
                    </div>
                  </li>
                ))}
              </ul>
