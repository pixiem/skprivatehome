...
const CopyrightText = ({ copyright_space, copyright_shape }) => {
  return (
    <>
      <div className={`bd-footer-copyright ${copyright_space ? copyright_space : 'pb-5'}`}>
        <div className="bd-footer-copyright-line pb-20">
          <Image src={copyright_shape ? copyright_shape : wave} style={{ width: "100%", height: "auto" }} alt="img not found" />
        </div>
